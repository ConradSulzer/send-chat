...
io.on('connection', (socket) => {
    ...
    socket.on('join', ({  username, room  }, callback) => {
        ...
        socket.emit('newMessage', generateMessage('Welcome to the site!'))
    ...
    socket.on('sendLocation', (location, callback) => {
        const user = getUser(socket.id);
        io.to(user.room).emit('locationLink', generateLocationMessage(`https://google.com/maps?q=${location.lat},${location.lon}`, user.username))
